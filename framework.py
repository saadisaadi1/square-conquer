...
class Scene:
    def __init__(self):
        ...
        self.initial_entities = {"root": self.root_entity}
...
class GameManager:
    ...
    @classmethod
    def create_new_entity(cls, kind, name, status="temporary",father = None):
...
"""
    ...
    def update(cls):
        ...
        for i in range(cls.trunks_number):
            ...
            t = cls.scene.active_entities["frog" + str(i)]
